...
//                    mErrorDialogHandler.showError("Invalid Card Data");
                    Toast.makeText(StripeActivity2.this, "Invalid Card Data", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                stripe.createToken(
                        ...
                        new TokenCallback() {
                            public void onSuccess(Token token) {
                                ...
                                Toast.makeText(StripeActivity2.this, token.getCard().toString(), Toast.LENGTH_SHORT).show();
                            }
